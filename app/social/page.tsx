...
export const metadata = {
  ...
  description: "Connect with Joseph on social media platforms",
  keywords: ["social media", "Instagram", "YouTube", "TikTok", "follow", "dance"],
};
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-16 p-6 bg-gray-900 border border-gray-800 rounded-xl">
              <p className="text-gray-400 text-sm">
                ...
                follow Joseph on all social media platforms.
              </p>
            </div>
          </div>
        </div>
